...
const { setSessionToken } = require("../utils/AuthService")
...
const HandleUserRegister = async (req, res) => {
    ...
    try {
      ...
      return res
        .cookie("SessionID", token, { httpOnly: true, secure: process.env.NODE_ENV === "production" })
        .status(201)
        .json({
...
const HandleUserLogin = async (req, res)=>{
    ...
    try {
        ...
        return res.cookie("SessionID", token).status(200).json({
